  ...
  return (
    <SafeAreaView style={[styles.screen, { backgroundColor: colors.background }]} edges={[]}>
      ...
      <View style={[styles.header, { backgroundColor: colors.headerBg }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.headerTintColor }]}>{t('admin')}</Text>
      ...
      <View style={styles.emptyState}>
        ...
        <Text style={[styles.emptyTitle, { color: colors.ink }]}>{t('adminPanel')}</Text>
        <Text style={[styles.emptyText, { color: colors.inkFaint }]}>{t('adminPanelText')}</Text>
      </View>
    </SafeAreaView>
  );
}
